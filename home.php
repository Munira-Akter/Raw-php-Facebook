...
<body>
		...
		<?php 
			$data = $connection -> query("SELECT * FROM info");
		...
		<div class="modal-dialog modal-dialog-centered shadow-sm">
			<div class="modal-content ">
				<div class="modal-body">
					...
					<a href="profile.php?profile_id=<?php echo $all_data['id']?>"><img src="photos/<?php echo $all_data['photo']?>" alt=""></a>
						<div class="post-user-info-details">
							<h4><a href="profile.php?profile_id=<?php echo $all_data['id']?>"> <?php echo $alldata['name']?> </a></h4>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5">
					<div class="main-menu">
						<ul>
							<li><a href="#"> <svg viewBox="0 0 28 28" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 em6zcovv" height="28"
										width="28">
										<path
				...
				<div class="col-md-4 clearfix">
					...
					<div class="notification-bar float-right">
						<ul>
							<li><a href="#"><svg viewBox="0 0 28 28" alt="" class="a8c37x1j ms05siws hwsy1cff b7h9ocf4 fzdkajry"
										height="20" width="20">
										<path
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-7">
					...
					<div class="story">
						<div class="row">
							<div class="col-md-3 p-0 sto">
								<div class="story-inner  shadow-lg">
								<a href="profile.php?profile_id=<?php echo $all_data['id']?>"><img src="photos/<?php echo $all_data['photo']?>" alt=""></a>
									<div class="add">
							...
							<div class="col-md-3 p-0 sto">
								<div class="story-inner  shadow-lg">
									...
									<div class="id"><img src="assets/media/img/pp_photo/rrr.jpeg" alt=""> <span>Zubayer</span> </div>
								</div>
							</div>
							<div class="col-md-3 p-0 sto">
								<div class="story-inner  shadow-lg">
							...
							<div class="card shadow-sm">
								<div class="card-body">
									...
									<div class="post-content mt-2">
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptate aspernatur voluptatum quidem
											nemo, veritatis tenetur doloribus est sed qui iste.</p>
									...
									<div class="comment-area">
										...
										<div class="post-user-comment clearfix">
											...
											<div class="comment-content">
												<h4>Asraful Haque</h4>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quos, at. Lorem ipsum dolor sit
													amet.</p>
											</div>
										</div>
